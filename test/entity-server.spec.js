...
describe('Subgenerator entity-server of modular-monolith JHipster blueprint', () => {
    describe('Test SQL JPA monolith prompts', () => {
        before(done => {
            helpers
    ...
    describe('Test SQL JPA monolith skip REST prompts', () => {
        before(done => {
            helpers
                .run('generator-jhipster/generators/entity')
                .inTmpDir(dir => {
    ...
    describe('Test SQL JPA monolith json file', () => {
        before(done => {
            helpers
                .run('generator-jhipster/generators/entity')
                .inTmpDir(dir => {
                    fse.copySync(path.join(__dirname, '../test/templates/default-with-entity'), dir);
                })
                .withOptions({
                    'from-cli': true,
                    skipInstall: true,
        ...
        it('keeps skipRest flag into entity json', () => {
            assert.JSONFileContent('.jhipster/Foo.json', { skipRest: true });
        });
